...
//    }
    ...
    public Object getAll()
   {
    ...
    @RequestMapping(value = "/getSubCategoryAndStockByListOfSubCategoryIds", method = RequestMethod.GET)
    public Object getSubCategoryAndStockByListOfSubCategoryIds(@RequestParam List<String> SubCategoryIds)
    {
        return categoryService.getSubCategoryAndStockByListOfSubCategoryIds(SubCategoryIds);
    }
